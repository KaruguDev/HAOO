...
- [ ] 04.1-01-PLAN.md — Restate the withdrawn bundle guarantee with a named successor and pin the PostHog capture contract *(wave 1)*
- [ ] 04.1-02-PLAN.md — Decide the PostHog API coverage matrix and re-point the coverage verifier *(wave 2)*
- [ ] 04.1-03-PLAN.md — Install the pinned SDK under a legitimacy gate and plant the repository-owned ingestion-host trust anchor *(wave 2)*
- [ ] 04.1-04-PLAN.md — Tracer: one HAOO event reaches a locked-down PostHog, and every Plausible artifact is removed *(wave 3)*
