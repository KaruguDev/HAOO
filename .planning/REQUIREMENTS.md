...
- [x] **QUAL-05**: Build, typecheck, lint, automated contract/component tests, and required deployed manual checks pass before launch
...
| QUAL-01 | Phase 5 | Complete (qualified, see Phase 5 status evidence) |
| QUAL-02 | Phase 5 | Complete (qualified, see Phase 5 status evidence) |
| QUAL-03 | Phase 5 | Complete (qualified, see Phase 5 status evidence) |
| QUAL-04 | Phase 04.2 | Complete |
| QUAL-05 | Phase 5 | Complete (qualified, see Phase 5 status evidence) |
...
|---|---|---|---|
| **Kenya Data Protection Act 2019 sign-off** (`02-VALIDATION.md:91`) | **OPEN — and explicitly NOT closed by the owner's copy approval.** The owner said so in terms at plan `04.2-04`'s gate: *"This approval covers visitor-facing wording ONLY. It does not close `02-VALIDATION.md:91`. Approving copy is not a data-protection review, and that item covers notice, storage, retention and processor decisions that need someone with legal standing to sign."* SPLT-04 above is Complete on the truth of the statements; that is a different claim from a data-protection review, and neither implies the other.<br><br>**2026-09-13 (plan 05-17 Task 2): ACCEPTED RISK, NOT RESOLVED.**<br>**Still outstanding.** The sign-off has not happened. No legal review has taken place, and nothing records the collection as compliant.<br>**Provenance.** Owner-accepted, orchestrator-drafted at the owner's request, and approved by the owner as written; the words are not the owner's own.<br>**Recorded sentence:** *"The owner accepts, as a known and unassessed risk, that the HAOO qualification form collects personal data on the live site before anyone with legal standing has determined whether that collection complies with the Kenya Data Protection Act 2019; the sign-off remains outstanding and is carried beyond Phase 5."* | someone with legal standing, engaged by the repository owner | not yet scheduled; carried beyond Phase 5 as an accepted, unassessed risk, and not closed by Phase 5 |
| **Mail routing for `haoo.online`** — no MX records; RFC 5321 implicit-MX falls back to the A record, which is GitHub Pages, which runs no SMTP, so mail to `info@haoo.online` very likely does not arrive. Owner decision recorded 2026-09-05: point MX at `mx1.privateemail.com` / `mx2.privateemail.com`. **The DNS change was deliberately scoped out of this phase.** `info@haoo.online` is the qualification-form fallback target, the `mailto:` onboarding link and a `noscript` recovery link. | **EXECUTED AND MEASURED (2026-09-13).** The MX change was made and measured from two resolvers: Link 1 CONFIRMED `2026-09-12T21:03:51Z`, re-measured `2026-09-13T01:11:43.608Z`. The FormSubmit endpoint was activated (Link 2 CONFIRMED on the owner's report). The tagged submission `HAOO-RELEASE-VERIFICATION-20260913T011059Z-b770730d` reached the `info@haoo.online` **inbox** (Link 3 CONFIRMED on the owner's report). Evidence: `.planning/phases/05-prove-the-deployed-journey/05-EVIDENCE-MAIL.md`. Earlier status: DECIDED, NOT EXECUTED. Re-derived by plan 05-17 on 2026-09-13 from that file, not inherited. The measured outcome stands: all three links CONFIRMED, with exactly 2 live submissions sent in Phase 5. | repository owner | Phase 5 / LEAD-07 |
| **The certificate serving the HAOO host was issued 2026-09-03, two days before the reclaim, while a third party held the Pages claim** (`04.2-DEFERRED-ITEMS.md` D34). Not a key compromise — Pages holds the key and never released it — but it is the certificate a CT-log monitor reads until 2026-12-02. | **ACCEPTED RISK, measured (2026-09-13, plan 05-17 Task 2).**<br>**Readings, 2026-09-13T08:19Z.** *Visitors (Cloudflare edge):* Let's Encrypt YE2, serial `06D56404362229A110326272D5DCCF6249D0`, issued 2026-09-09, valid to 2026-12-08. *GitHub Pages origin:* still Let's Encrypt YR2, serial `0609A5171B8224FD0D181CCBEC9CC50E7CC1`, issued 2026-09-03, valid to 2026-12-02.<br>**Unknown.** The Cloudflare SSL mode; whether the platform ever replaces the origin certificate.<br>**Provenance.** Owner-accepted, orchestrator-drafted at the owner's request, and approved by the owner as written.<br>**Recorded sentence:** *"The owner accepts that the GitHub Pages origin for haoo.online still serves the Let's Encrypt certificate issued on 2026-09-03 (serial 0609A5171B8224FD0D181CCBEC9CC50E7CC1, valid until 2026-12-02) while a third party held the Pages claim, given that visitors receive Cloudflare's edge certificate issued on 2026-09-09 after the reclaim, GitHub holds the private key, and the platform has not replaced the origin certificate."*<br>Certificate-transparency monitoring stays deferred. Evidence: `05-EVIDENCE-GATES.md` §6.8. | repository owner | accepted at Phase 5; origin certificate expires 2026-12-02 |
...
### Phase 5 status evidence, set 2026-09-13 by plan `05-17` task 3

**Every row below is set from a measured result, never from a plan having executed.** LEAD-07 was
re-derived here from the mail record, not inherited from 05-16's checkbox. "Qualified" means the
measured evidence meets the statement over a stated sample, with named items not measured or held for
a human. The successor for each is named. The consolidated record is
`.planning/phases/05-prove-the-deployed-journey/05-EVIDENCE.md`.

| ID | Status | Measured evidence | Not proven, and its successor |
|---|---|---|---|
| **LEAD-07** | Complete | **Link 1, MX.** `dig` from the local resolver and 8.8.8.8 named `10 mx1/mx2.privateemail.com`, CONFIRMED 2026-09-12T21:03:51Z and re-measured 2026-09-13T01:11:43.608Z. **Link 2, activation.** CONFIRMED on the owner's report, corroborated by delivery of marker `HAOO-ENDPOINT-ACTIVATION-20260913T003033Z-571c962a` at 00:33:02 +0000. **Link 3, delivery.** Marker `HAOO-RELEASE-VERIFICATION-20260913T011059Z-b770730d` was committed before the send (`49c976a`), sent as 1 message at 01:11:46.454Z, and reported by the owner in the `info@haoo.online` **inbox**. **Recovery paths in this plan's live run (2026-09-13T08:22:33Z).** `https://manage.haoo.online/` 200 and the brochure PDF 200. `tel:`, `mailto:` and `wa.me` validated by form, not fetched. (`05-EVIDENCE-MAIL.md`, `05-EVIDENCE-RECOVERY.md`) | Links 2 and 3 rest on the owner's mailbox report, not on an instrument this project controls. One tagged sample was sent. The full sender and subject were not stated. Nothing further is owed for the statement. |
| **QUAL-01** | Complete (qualified) | **Widths.** Live S1 and S3 at the six D-09 widths gave 0 in-scope escapees in the per-element sweep, and `scrollWidth` equalled `clientWidth` unmodified and mask-neutralised. **Primary actions.** P1–P13 were reachable by name, visible, unclipped and at least 44 × 44. **Re-measured in this plan.** `viewport.e2e.ts` live 40 of 40, 2026-09-13; values identical to the committed records apart from the F1-LIVE `href` correction. (`05-EVIDENCE-VIEWPORT.md`, `05-EVIDENCE-GATES.md` §6) | Widths between matrix entries are not swept (planner assumption, 05-08). The Products grid and empty branches are covered by jsdom only. Native `<select>` popups are not visible to the sweep. The 360 px option-label readability item is held out for human judgement, not a pass. **Successor:** `/gsd-verify-work 05`. ZERO-PAPER HUB outside `#products` is deferred by D-OQ-3. |
| **QUAL-02** | Complete (qualified) | **Keyboard traversal.** 36 stops at 320/360/390 and 40 at 768/1280/1440; every stop's indicator changed. 0 order violations and 0 positive tab indices. The skip link is the first stop and lands in `main`. **Brochure actions.** Ordinary tab stops, not modal. **Form states.** 0 of 23 focus transitions landed on the body. **Re-measured in this plan.** `keyboard.e2e.ts` live 25 of 25 and `form-states.e2e.ts` live 5 / preview 9, 2026-09-13. (`05-EVIDENCE-KEYBOARD.md`, `05-EVIDENCE-FORM-STATES.md`) | KB-O2: the embedded PDF viewer's keyboard behaviour is not evidenced in either direction, because headless Chromium has no PDF plugin (a recorded browser limit). Assistive-technology virtual-cursor navigation is not observable (05-09 assumption). FS-O1 (2 `role="status"` elements, 1 submission region) is routed to verification. **Successor:** `/gsd-verify-work 05`. |
| **QUAL-03** | Complete (qualified) | **Headings, landmarks and names.** Heading order checked by DOM walk; landmarks and accessible names asserted. **Brochure HTML equivalent.** 10 of 10 items (6 capabilities, 4 journey steps), also with the artifact route aborted. **Zoom.** Reflow at 640/720 (200%) and 320 × 256 with 0 escapees and content intact. **Reduced motion.** ZM-LIVE-1/2 fixed in `65a612a` and deployed; the live reading at 2026-09-13T08:23:23Z was `transformAfter` `none` and `transitionProperty` `none`, while the control still translates. **Accessibility gate.** 0 unexcepted blocking nodes; R-1 is excepted. **Re-measured in this plan.** `semantics` 12, `zoom-motion` 21 and `axe-gate` 8 live, 2026-09-13. (`05-EVIDENCE-SEMANTICS.md`, `05-EVIDENCE-ZOOM-MOTION.md`, `05-EVIDENCE-AXE.md`) | E1 (line length inside max-width columns at halved desktop) and E3 (brochure equivalent readability at 360 and 200%) are held out for human judgement, not passes. **Successor:** `/gsd-verify-work 05`. R-1 is an accepted exception, not a fix. |
| **QUAL-05** | Complete (qualified) | **Gates.** 13 enumerated commands, read from each manifest, exited 0 in this plan (2026-09-13T08:20Z–08:21Z). *HAOO:* build, typecheck, lint, `npm test` (688 tests / 10 files), `verify:coverage`, `verify:disjoint` (26/26/26, 0 violations), `test:phase1:contracts`. *ZERO-PAPER HUB:* the same set without coverage, with `npm test` at 32 / 3. **Deployments.** `Deploy HAOO` `34729513221`, `Verify tree disjointness` `34729513230` (both on `2d45e5f`) and `Deploy ZERO-PAPERHUB` `34714952939` (on `3525f6d`) all concluded success, and the deployed commits contain every Phase 5 source fix. **Live evidence pass.** 141 collected, 128 expected, 13 skipped, exit 0; preview 33 / 108, exit 0. **Deployed manual checks.** The three owner mailbox confirmations of LEAD-07 were made and recorded. (`05-EVIDENCE-GATES.md` §6) | The enumeration is the planner's closed definition of "checks pass" (05-17 assumption). The three held-out human judgements (option labels, E1, E3) are not yet made and are not passes. **Successor:** `/gsd-verify-work 05`. The owner's own PostHog web and product analytics check is pending, an open owner item outside this requirement. |
...
*Amended: 2026-09-13 — plan 05-17 task 3 set the five Phase 5 statuses from measured evidence (see § Phase 5
status evidence): LEAD-07 Complete (re-derived, not inherited), QUAL-01, QUAL-02, QUAL-03 and QUAL-05 Complete
(qualified), each naming what was not proven and its successor, `/gsd-verify-work 05`. The Kenya DPA 2019 row and
the certificate row carry the owner's Task 2 disposition, `accepted`, recorded with its provenance (owner-accepted,
orchestrator-drafted at the owner's request, approved as written). The Kenya DPA sign-off remains outstanding and is
carried beyond Phase 5. Status tally, recounted from the traceability table: 28 Complete (4 of them qualified),
8 Gaps Found, 0 Pending, 36 rows.*
