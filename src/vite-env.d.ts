 ...
 * `resolveMeasurementProvider` / `resolvePlausibleScriptSrc` in favour of the inert
 * no-op sink, so a build with no configuration at all still ships a working submission
 * destination and no analytics.
 *
