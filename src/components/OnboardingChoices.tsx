...
export default function OnboardingChoices({
  product,
  position,
  track,
  ...
  function handlePhoneContact() {
    track(product.measurement.interactionEvents.assistedPhone);
  }

  function handleEmailContact() {
    track(product.measurement.interactionEvents.assistedEmail);
  }

  function handleSelfOnboarding() {
    track(product.measurement.interactionEvents.selfOnboarding);
  }
